    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאסטר אספניול משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'ddd813be-600e-4034-bcf6-d6de74b3fb23',
                    name: data.name || '',
                    email: data.email || '',
